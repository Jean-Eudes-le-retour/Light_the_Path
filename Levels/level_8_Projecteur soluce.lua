...
--grid.fit(t,xpos,ypos,state,rotation,color,canMove,canRotate,canChangeColor,glassState)
  ...
  grid.set(TYPE_MIRROR, 5, 3, {state = 2, rotation = 2})
  grid.set(TYPE_MIRROR, 8, 3, {state = 2, rotation = 2})
  --grid.set(TYPE_MIRROR, 2, 5, {rotation = 1})
  grid.set(TYPE_PWHEEL, 3, 5, {rotation = 1, color = COLOR_YELLOW})
  grid.set(TYPE_MIRROR, 5, 5, {state = 2, rotation = 2, color = COLOR_BLUE})
  grid.set(TYPE_MIRROR, 8, 5, {state = 2, rotation = 1, color = COLOR_YELLOW})
