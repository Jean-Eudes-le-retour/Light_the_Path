...
--grid.fit(t,xpos,ypos,state,rotation,color,canMove,canRotate,canChangeColor,glass,canChangeState)
  ...
  grid.fit(TYPE_SOURCE,nil,nil,{state = 2, rotation = 3, color = (math.floor(math.random()*20)%7)+1, canMove = true, canRotate = true})
  grid.fit(TYPE_RECEIVER,nil,nil,{state = 1, rotation = 1, color = COLOR_BLACK, canMove = true, canRotate = true})
  grid.fit(TYPE_RECEIVER,nil,nil,{state = 2, rotation = 1, color = 3})
  ...
  grid.fit(TYPE_LOGIC,nil,nil,{state = LOGIC_OR, canMove = true, canRotate = true}):setSides(nil,"in","in","out")
  grid.fit(TYPE_LOGIC,nil,nil,{state = LOGIC_AND, canMove = true, canRotate = true}):setSides("in","in","in","out")
  grid.fit(TYPE_LOGIC,nil,nil,{state = LOGIC_AND, canMove = true, canRotate = true}):setSides("in",nil,"in","out")
  grid.fit(TYPE_LOGIC,nil,nil,{state = LOGIC_NOT, canMove = true, canRotate = true}):setSides(nil,"in","in","out")
  grid.fit(TYPE_RECEIVER,nil,nil,{color = COLOR_BLACK, canMove = true, canRotate = true}):setSides(nil,nil,"activate",nil)
